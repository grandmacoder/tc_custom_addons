<?php
//Widget class for Join the discussion widget on bbpress

add_action( 'widgets_init', function(){
     register_widget( 'tc_custom_forum_widget' );
});

if(!class_exists('tc_custom_forum_widget')) {
//begin class
class tc_custom_forum_widget extends WP_Widget {
 
    public function __construct() {
        // widget actual processes
		 $widget_ops = array( 'classname' => 'tc_custom_forum_widget', 'description' => __( 'A list of forums to show private and published discussion forums.' ) );
...
}//end of tc custom forum widget class
}
?>